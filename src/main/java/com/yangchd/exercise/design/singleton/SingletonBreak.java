...
import com.yangchd.exercise.design.singleton.lazy.SingletonLazyDoubleCheck;
...
public class SingletonBreak {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> clazz = Class.forName("com.yangchd.exercise.design.singleton.lazy.SingletonLazyDoubleCheck");
