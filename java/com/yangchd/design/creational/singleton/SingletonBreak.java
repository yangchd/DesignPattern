...
import com.yangchd.design.creational.singleton.demo.SingletonLazyDoubleCheck;
...
public class SingletonBreak {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> clazz = Class.forName("com.yangchd.design.creational.singleton.demo.SingletonLazyDoubleCheck");
